...
const Items = ({currentCategory}) => {
    ...
    const currentProducts = currentCategory !== "All" ? products.filter((item) => item.category === currentCategory) : products

    const renderCards = currentProducts.map((item) => <Card item={item} />)
