...
export const ProductProvider = ({ children }) => {
    ...
    const fruitsAndVeggies = allProducts.filter((item) => item.category === 'Fruits' || item.category === 'Vegetables');

    const dairy = allProducts.filter((item) => item.category === 'Dairy');

    const meatAndSeaFood = allProducts.filter((item) => item.category === 'Meat' || item.category === 'SeaFood')
